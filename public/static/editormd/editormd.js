...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        save : function() {
           ...
           // console.log(editormd.$marked.InlineLexer.rules)
    ...
    editormd.markedRenderer = function(markdownToC, options) {
        ...
        markedRenderer.httpmethod = function (method,href) {
            if(method && href){
                var $caseMethod = method.toLowerCase();
                return '<div class="http-method"><span class="default '+ $caseMethod +'">'+method+'</span>' + href + '</div>';
            }
            return '';
        };
